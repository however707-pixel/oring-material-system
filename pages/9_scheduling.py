...
if "wo_data" not in st.session_state or not REQUIRED_COLS.issubset(st.session_state.wo_data.columns):
    st.session_state.wo_data = pd.DataFrame([
        dict(工單號="5220-20260501001",產品="IGS-9122GP",產品品號="9-xxx",類型="廠內",工序="組裝",產線="宣-1線",數量=100,已生產量=60,未生產量=40,UPH=12,開工=date(2026,5,1),完工=date(2026,5,4),狀態="生產中",優先順序=1),
        dict(工單號="5220-20260501001",產品="IGS-9122GP",產品品號="9-xxx",類型="廠內",工序="測試",產線="測試站A",數量=100,已生產量=0,未生產量=100,UPH=20,開工=date(2026,5,5),完工=date(2026,5,6),狀態="待開工",優先順序=1),
        dict(工單號="5220-20260501001",產品="IGS-9122GP",產品品號="9-xxx",類型="廠內",工序="包裝",產線="包裝線",數量=100,已生產量=0,未生產量=100,UPH=30,開工=date(2026,5,7),完工=date(2026,5,8),狀態="待開工",優先順序=1),
        dict(工單號="MO02-20260501001",產品="機殼-A型",產品品號="1511-xxx",類型="委外",工序="委外",產線="唐佑",數量=500,已生產量=200,未生產量=300,UPH=50,開工=date(2026,5,1),完工=date(2026,5,10),狀態="生產中",優先順序=2),
    ])
...
with tab3:
    ...
    show_cols = ["工單號","產品","類型","工序","產線","數量","已生產量","未生產量","開工","完工","狀態"]
