TEXTS = {
    "zh": {
        ...
        "dept_full_flow":     "全流程",
        "dept_full_flow_sub": "Full Process Flow",
        "link_full_process":  "全製程",
        "link_pmc_order": "廠銷訂單追蹤",
        "link_wo_trace":  "全工單料況追蹤",
        "link_tangyou_reply": "唐佑缺料回信",
        ...
        "link_kanban":       "工單進度看板",
        "link_outsource_schedule": "委外工單排程",
        "link_wh_dashboard": "倉儲備料看板",
        "link_wh_assessment": "年度倉儲考核依據表",
        "dept_rma":      "RMA",
        "dept_rma_sub":  "Return Material Authorization",
        "link_rma_summary": "RMA總表",
        "dept_ps":       "製程站",
        "dept_ps_sub":   "Process Station",
        "link_assembly": "組裝",
        "link_test_station": "測試",
        "link_packaging": "包裝",
        "link_total_worktime": "總計工時表",
        "todo_title":    "待建流程 · To-do",
        "todo_badge":    "待建",
        "todo_mc_arrival":  "料件到貨追蹤",
        "todo_pc_confirm":  "客戶訂單確認",
        "todo_pc_release":  "工單發佈",
        "todo_pc_report":   "完工確認回報",
        "todo_wh_iqc":      "入庫驗收 / IQC",
        "todo_wh_putaway":  "儲位上架管理",
        "todo_wh_packing":  "出貨包裝作業",
        "todo_wh_shipping": "出貨確認 / 交運",
        ...
        "flow_title":    "物料作業流程管理架構",
        "flow_sub":      'Material Flow Management Architecture <span class="sep">|</span> PMC &times; PC 生管 &times; MC 物管 &times; WH 倉管',
        "flow_chain":    "物料需求 &rarr; 採購/調撥 &rarr; 入庫/IQC &rarr; 備料/領料 &rarr; 出貨/成本回報",
        "flow_tagline":  "🛡&nbsp;&nbsp; 精準協同 &nbsp;·&nbsp; 流程透明 &nbsp;·&nbsp; 數據驅動 &nbsp;·&nbsp; 持續改善",
...
""",
    ...
    "en": {
        ...
        "dept_full_flow":     "Full Flow",
        "dept_full_flow_sub": "Full Process Flow",
        "link_full_process":  "Full Process",
        "link_pmc_order": "Factory Sales Order Tracking",
        "link_wo_trace":  "All WO Material Tracking",
        "link_tangyou_reply": "Tang You Shortage Reply",
        "link_transfer": "Transfer Decision Board",
        "link_outsource":"Outsource Confirmation",
        "link_h2o":      "Tang You Allocation",
        "link_guozhi":   "Guo Zhi Allocation",
        "link_factory":  "Factory Allocation",
        "link_wo_progress": "Work Order Progress",
        "link_shortage_detail": "Period Shortage Detail",
        "link_full_trace": "Plant-wide Material Trace",
        ...
        "link_outsource_schedule": "Outsourcing WO Scheduling",
        "link_wh_dashboard": "Warehouse Prep Dashboard",
        "link_wh_assessment": "Annual Warehouse KPI Sheet",
        "dept_rma":      "RMA",
        "dept_rma_sub":  "Return Material Authorization",
        "link_rma_summary": "RMA Summary",
        "dept_ps":       "Process Station",
        "dept_ps_sub":   "",
        "link_assembly": "Assembly",
        "link_test_station": "Testing",
        "link_packaging": "Packing",
        "link_total_worktime": "Total Worktime Sheet",
        "todo_title":    "To-do",
        "todo_badge":    "TBD",
        "todo_mc_arrival":  "Material Arrival Tracking",
        "todo_pc_confirm":  "Customer Order Confirmation",
        "todo_pc_release":  "Work Order Release",
        "todo_pc_report":   "Completion Reporting",
        "todo_wh_iqc":      "Receiving / IQC",
        "todo_wh_putaway":  "Put-away Management",
        "todo_wh_packing":  "Outbound Packing",
        "todo_wh_shipping": "Shipment Confirm / Dispatch",
        ...
        "flow_title":    "Material Flow Management Architecture",
        "flow_sub":      '物料作業流程管理架構 <span class="sep">|</span> PMC &times; PC &times; MC &times; WH',
        "flow_chain":    "Material Demand &rarr; Purchasing/Transfer &rarr; Receiving/IQC &rarr; Picking/Issue &rarr; Shipping/Cost Report",
        "flow_tagline":  "🛡&nbsp;&nbsp; Precision Collaboration &nbsp;·&nbsp; Process Transparency &nbsp;·&nbsp; Data-Driven &nbsp;·&nbsp; Continuous Improvement",
